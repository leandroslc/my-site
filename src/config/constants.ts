...
export const YOUTUBE_URL =
  'https://www.youtube.com/channel/UC9W-QxRYVkGSu2_dsZyLoVQ'
export const CSS_THEME_PROPS_PREFIX = '--lb-tm'
export const CSS_DARK_THEME_CLASS = 'dark'
export const CODE_HIGHLIGHT_BASE_URL = '/code'
